...
import type { Castagne } from '../target/types/castagne';
import CastagneIDL from '../target/idl/castagne.json';
...
export function getCastagneProgramId(cluster: Cluster) {
  switch (cluster) {
    ...
    case 'testnet':
      ...
      return new PublicKey('6rvpwcnY7hdSDLob9Q66kkSSmsJKRC5KzGieQE2XuJjr');
    case 'mainnet-beta':
    default:
